            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-6">
                <div className="flex-1">
                  <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">{box.name}</h1>
                ...
                <div className="text-right sm:ml-6 mt-4 sm:mt-0">
                  <div className="text-3xl font-bold text-primary">{formatPrice(box.price)}</div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">{"Innendørs"}</div>
                  </div>
                </div>
                  ...
                  {box.stable.images.slice(0, 4).map((image, index) => (
                    <div key={index} className="relative aspect-video">
                      <Image
                        src={image}
                        alt={
                          box.stable.imageDescriptions?.[index] ||
                          `Bilde ${index + 1} fra ${box.stable.name}`
                        }
                        fill
