...
// import { useAllRentals } from "@/hooks/useRentalQueries"; // TODO: Create this hook
...
export default function StallClient({ stables: initialStables }: StallClientProps) {
  ...
  useEffect(() => {
    ...
    if (
      tabParam &&
      ["overview", "stables", "rentals", "services", "analytics"].includes(tabParam)
    ) {
                ...
                <div className="space-y-8">
                  {stables.map((stable) => (
                    <div key={stable.id} className="space-y-6">
                      ...
                      {groupedStableRentals[stable.id] &&
                        groupedStableRentals[stable.id].length > 0 && (
                                ...
                                >
                                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                                    <div className="flex-1">
                                      ...
                                      <p className="text-sm text-slate-500">
                                        Fra:{" "}
                                        {new Date(rental.startDate).toLocaleDateString("nb-NO")}
                                      </p>
                                    </div>
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-slate-600 text-sm">Stallbokser som jeg leier</p>
                </div>
              </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-amber-700 space-y-1">
                        <p>
                          <strong>
                            Leieforholdene som vises her er kun for administrasjon og oppfølging på
                            plattformen.
                          </strong>
                        </p>
                        <p>
                          Dette er <strong>ikke juridiske leiekontrakter</strong> med stallen.
                          Reelle leievilkår, betalingsordninger og juridiske forhold må avtales
                          direkte mellom deg og stallieren utenfor denne plattformen.
                        </p>
                        <p className="mt-2 font-medium">Plattformen brukes kun til å:</p>
              ...
              {rentals.isLoading ? (
                ...
                <div className="text-center py-8">
                  ...
                  <Button variant="outline" onClick={() => router.push("/staller")}>
                    Finn stallplass
                  </Button>
                </div>
              ) : (
