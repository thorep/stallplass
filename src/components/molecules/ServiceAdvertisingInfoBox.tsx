...
interface ServiceAdvertisingInfoBoxProps {
  show: boolean;
}

export default function ServiceAdvertisingInfoBox({ show }: ServiceAdvertisingInfoBoxProps) {
  if (!show) return null;
      ...
      <AlertDescription className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="space-y-2">
          <p className="text-body font-medium text-amber-800">
            Din tjeneste er ikke synlig for andre
          </p>
