...
import { useCareLogs, useExerciseLogs, useFeedingLogs, useMedicalLogs, useOtherLogs } from "@/hooks/useHorseLogs";
...
export default function HorseDetailPage() {
  ...
  const [logModalType, setLogModalType] = useState<"care" | "exercise" | "feeding" | "medical" | "other">("care");
          ...
          <div className="mb-8">
            ...
            onSave={() =>
              saveSection("physical", {
                gender: editingData.gender && editingData.gender !== "NONE"
          ...
          <div className="mb-8">
            ...
            onSave={() =>
              saveSection("description", {
                description: editingData.description ? String(editingData.description) : undefined,
              })
            }
            onCancel={cancelEditing}
            isLoading={updateHorse.isPending}
