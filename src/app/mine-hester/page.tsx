...
import HorseSkeletonLoading from "@/components/horses/HorseSkeletonLoading";
import Footer from "@/components/organisms/Footer";
import Header from "@/components/organisms/Header";
import MineHesterContainer from "@/components/organisms/MineHesterContainer";
...
export type HorsesWithOwner = Prisma.horsesGetPayload<{
...
export default async function MineHesterPage() {
  ...
  if (!data.user) return <NoUser />;
  if (!data.user.email_confirmed_at) return <NoEmailConfirmed />;
  ...
  return (
    <div className="min-h-screen bg-white">
      <Header />
      <main>
        <Suspense fallback={<HorseSkeletonLoading />}>
          <MineHesterContainer user={data.user} />
        </Suspense>
            ...
            <Grid container spacing={4} className="mt-12">
              ...
              <Grid size={{ xs: 12, md: 6 }}>
                ...
                >
                  ...
                  <Typography variant="body1" className="text-body-sm text-gray-600">
                    Loggfør daglige aktiviteter, treningsøkter, veterinærbesøk og medisinering. Følg
                    med på hestens utvikling over tid.
                  </Typography>
                </Paper>
              </Grid>
              ...
              <Grid size={{ xs: 12, md: 6 }}>
                ...
                >
                  ...
                  <Typography variant="body1" className="text-body-sm text-gray-600">
                    Gi tilgang til trenere, ryttere eller veterinærer. Samarbeid om hestens velvære
                    og del all informasjon enkelt.
                  </Typography>
                </Paper>
              </Grid>
            </Grid>
