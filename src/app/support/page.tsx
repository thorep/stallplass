            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Se vår <a href="/priser" className="text-primary hover:underline">prisside</a> for
                    oppdatert informasjon om kostnader.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Du kan bruke meldingsfunksjonen på stallsiden for å sende
                    en melding direkte til stallieren. Du kan også ringe eller
                    sende e-post hvis denne informasjonen er tilgjengelig.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Kontakt oss på support@stallplass.no så hjelper vi deg med
                    å slette din brukerkonto og alle tilknyttede data.
                  </p>
                </div>
              </div>
            </div>
